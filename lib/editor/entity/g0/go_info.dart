...
class G0Info extends ConsumerStatefulWidget with Info {
  final int id;
  final Function selectFunction;
  G0Info({super.key, required this.id, required this.selectFunction});

  @override
  ConsumerState<G0Info> createState() => _G0InfoState();
}

class _G0InfoState extends ConsumerState<G0Info> {
  bool selected = false;
